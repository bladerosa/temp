// NormalNotice: replicates original "创建通知/公告" screen
// All fields are placeholders (no interactions) EXCEPT 通知目标 which uses TargetSelector
...
function NormalNotice() {
  ...
  return (
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: 0, padding: '0 32px 32px' }}>
        <Card padding={24} style={{ marginBottom: 24 }}>
          ...
          {/* Content editor + preview (placeholder only) */}
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
            <Field label="内容">
              <RichTextPlaceholder />
            </Field>
...
function PageHeader({ title, backable, onBack, actions }) {
  return (
    <div style={{
    ...
    <div style={{
      ...
      <div style={{
        ...
        {Array.from({ length: 14 }).map((_, i) => (
          <span key={i} style={{
            width: 22, height: 22,
            background: '#F6F7FB', borderRadius: 4,
          }} />
        ))}
      </div>
      <div style={{
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <span style={{ width: 18, height: 18, background: 'var(--primary)', borderRadius: 4 }} />
          ccpayment
        </div>
      </div>
      <div style={{ padding: '30px 20px', textAlign: 'center' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center', gap: 14, marginBottom: 16, color: 'var(--text-2)' }}>
          <span style={{ width: 20, height: 20, background: '#E9ECFA', borderRadius: 4 }} />
          <span style={{ width: 20, height: 20, background: '#E9ECFA', borderRadius: 4 }} />
          <span style={{ width: 20, height: 20, background: '#E9ECFA', borderRadius: 4 }} />
        </div>
...
Object.assign(window, { NormalNotice, PageHeader, SectionTitle });
