...
import { IconLink, IconCopy, IconChevronLeft } from './icons';
...
export function RichTextPlaceholder() {
  return (
    <div style={{ border: '1px solid var(--border)', borderRadius: 8, background: '#fff', overflow: 'hidden', minHeight: 280 }}>
      ...
      <div style={{ display: 'flex', gap: 4, padding: '6px 8px', borderBottom: '1px solid var(--border)', color: 'var(--text-3)' }}>
...
export function EmailPreviewPlaceholder() {
  return (
