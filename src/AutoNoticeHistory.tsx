...
const STATUS_OPTIONS = [
  { value: 'sending', label: '通知中', color: 'warn' as const },
  { value: 'sent', label: '已通知', color: 'success' as const },
  { value: 'failed', label: '通知失败', color: 'danger' as const },
];
          ...
          <div style={{ padding: '14px 16px', display: 'flex', alignItems: 'flex-end', gap: 12, flexWrap: 'wrap' }}>
            ...
            <FilterField label="通知状态">
              <select value={filters.status} onChange={e => setF('status', e.target.value)}
                style={{ ...inputStyle(130), appearance: 'auto' as React.CSSProperties['appearance'] }}>
...
function CellMono({ children, muted }: { children: React.ReactNode; muted?: boolean }) {
  return (
    <div style={{
