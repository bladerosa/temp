...
export interface RiskWithdrawal {
  ...
  memo?: string;
  /**
   * 非批量退款所对应的那一笔风险充值的记录 ID。
   * 批量退款不用这个字段，其覆盖范围由批次 ID 反查。
   */
  source?: string;
}
...
export const PAYMENTS: RiskPayment[] = [
  ...
  { id: '20260506022733156483113483', type: '直接儲值', symbol: 'USDT', amount: '+ 0.5 USDT', chain: 'TRON', from: 'TY8z8xvCRF…m3Xydy2Uof', txid: '015427dd37…9b15019e8e', time: '06 May. 2026 02:27', reprocess: 'refunded' },
  { id: '20260430094144123152448467', type: '直接儲值', symbol: 'TRX', amount: '+ 0.000007 TRX', chain: 'TRON', from: 'TTXSwp47kJ…HFxDm7FqaV', txid: '96df8752a0…f4ca880601', time: '30 Apr. 2026 09:41', reprocess: 'refunded' },
  { id: '20260430094115284442953523', type: '直接儲值', symbol: 'POL', amount: '+ 1 POL', chain: 'Polygon', from: '0x50e281e7d0…79483c3d31', txid: '0x8659284ed8…a1ff4c8a92', time: '30 Apr. 2026 09:41', reprocess: 'refunded' },
  { id: '20260430071122615808945850', type: '直接儲值', symbol: 'USDT', amount: '+ 2 USDT', chain: 'Polygon', from: '0x4766dc52…9db104e37e', txid: '0xe3c515fffe…9e8eb6bf5f', time: '30 Apr. 2026 07:11', reprocess: 'rejected' },
  { id: '20260430070953450037982634', type: '直接儲值', symbol: 'USDT', amount: '+ 2 USDT', chain: 'Polygon', from: '0x4766dc52…9db104e37e', txid: '0x72d7ec7153…7f35e6d7ec', time: '30 Apr. 2026 07:09', reprocess: 'rejected' },
  { id: '20260430065452468289240412', type: '直接儲值', symbol: 'USDT', amount: '+ 2 USDT', chain: 'Polygon', from: '0x4766dc52…9db104e37e', txid: '0xe5ec876eb4…bee277913e', time: '30 Apr. 2026 06:54', reprocess: 'rejected' },
  { id: '20260430064414482003296755', type: '直接儲值', symbol: 'USDT', amount: '+ 2 USDT', chain: 'Polygon', from: '0x50e281e7d0…79483c3d31', txid: '0xdc5362a116…a8168aac2d', time: '30 Apr. 2026 06:44', reprocess: 'rejected' },
  { id: '20260430061837400388661054', type: '直接儲值', symbol: 'USDT', amount: '+ 2 USDT', chain: 'Polygon', from: '0x4766dc52…9db104e37e', txid: '0x3200eac8d0…0f5443aa71', time: '30 Apr. 2026 06:18', reprocess: 'rejected' },
  { id: '20260430030425664521525697', type: '直接儲值', symbol: 'USDT', amount: '+ 3.8 USDT', chain: 'TRON', from: 'TTXSwp47kJ…HFxDm7FqaV', txid: 'ac8063491e…efb4b1ccf0', time: '30 Apr. 2026 03:04', reprocess: 'rejected' },
  ...
  { id: '20260319112811250036702951', type: '直接儲值', symbol: 'USDT', amount: '+ 0.5 USDT', chain: 'TRON', from: 'TY8z8xvCRF…m3Xydy2Uof', txid: '216b638dd6…eb262186b2', time: '19 Mar. 2026 11:28', reprocess: 'refunded' },
  ...
  { id: '20260318183212122005761331', type: '直接儲值', symbol: 'USDT', amount: '+ 0.2 USDT', chain: 'TRON', from: 'TTXSwp47kJ…HFxDm7FqaV', txid: 'f8996c43ec…6f98da7cdc', time: '18 Mar. 2026 18:32', reprocess: 'refunded' },
  { id: '20260318181504755476010902', type: '直接儲值', symbol: 'HBAR', amount: '+ 3.5 HBAR', chain: 'Hedera', from: '0.0.4728193', txid: '82016dd931…1c037e409f', time: '18 Mar. 2026 18:15', reprocess: 'failed', memo: '010902' },
  ...
  { id: '20260306110610810083728455', type: '直接儲值', symbol: 'USDT', amount: '+ 1.5 USDT', chain: 'TRON', from: 'TMhCk9FQs2…kuBJWKHUof', txid: 'e89c2a3e73…c7136b86ba', time: '06 Mar. 2026 11:06', reprocess: 'refunded' },
...
export const WITHDRAWALS: RiskWithdrawal[] = [
  ...
  { id: '20260506030433403575143482', symbol: 'USDT', amount: '- 0.5 USDT', chain: 'TRON', fee: '34.343 USDT', to: 'TMhCk9FQs2P7mDGRZ1PhZns8…', txid: '3b02fd16cc…e4d5002dbf', time: '06 May. 2026 11:11', status: 'success', source: '20260506022733156483113483' },
  { id: '20260430101844401510079714', symbol: 'TRX', amount: '- 0.000007 TRX', chain: 'TRON', fee: '8.15575 USDT', to: 'TMhCk9FQs2P7mDGRZ1PhZns8…', txid: 'dc4300c749…580ea3d552', time: '06 May. 2026 11:11', status: 'success', source: '20260430094144123152448467' },
  { id: '20260430101815401509960028', symbol: 'POL', amount: '- 1 POL', chain: 'Polygon', fee: '0.00665733 USDT', to: '0x4766dc5207f5172c05da8d…', txid: '0x849d8c94…37f114781c', time: '30 Apr. 2026 18:21', status: 'success', source: '20260430094115284442953523' },
  { id: '20260430074822401472239188', symbol: 'USDT', amount: '- 2 USDT', chain: 'Polygon', fee: '0.0244 USDT', to: '0x4766dc5207f5172c05da8d…', txid: '', time: '--', status: 'rejected', source: '20260430071122615808945850' },
  { id: '20260430074653401471866905', symbol: 'USDT', amount: '- 2 USDT', chain: 'Polygon', fee: '0.0244 USDT', to: '0x4766dc5207f5172c05da8d…', txid: '', time: '--', status: 'rejected', source: '20260430070953450037982634' },
  { id: '20260430073152401468085714', symbol: 'USDT', amount: '- 2 USDT', chain: 'Polygon', fee: '0.02402 USDT', to: '0x4766dc5207f5172c05da8d…', txid: '', time: '--', status: 'rejected', source: '20260430065452468289240412' },
  { id: '20260430072114401465409622', symbol: 'USDT', amount: '- 2 USDT', chain: 'Polygon', fee: '0.02402 USDT', to: '0x4766dc5207f5172c05da8d…', txid: '', time: '--', status: 'rejected', source: '20260430064414482003296755' },
  { id: '20260430065537401458963350', symbol: 'USDT', amount: '- 2 USDT', chain: 'Polygon', fee: '0.02416 USDT', to: '0x4766dc5207f5172c05da8d…', txid: '', time: '--', status: 'rejected', source: '20260430061837400388661054' },
  { id: '20260430034125401410092518', symbol: 'USDT', amount: '- 3.8 USDT', chain: 'TRON', fee: '61.56 USDT', to: 'TMhCk9FQs2P7mDGRZ1PhZns8…', txid: '', time: '--', status: 'rejected', source: '20260430030425664521525697' },
  { id: '20260319204518679966098506', symbol: 'TRX', amount: '- 0.000001 TRX', chain: 'TRON', fee: '25.641 USDT', to: 'TTXSwp47kJ…HFxDm7FqaV', txid: '5676c480a8…c260a61834', time: '19 Mar. 2026 20:45', status: 'success', source: '20260319200418386412093771' },
  ...
  { id: '20260319120540386316700142', symbol: 'USDT', amount: '- 2 USDT', chain: 'TRON', fee: '30.288 USDT', to: 'TMhCk9FQs2P7mDGRZ1PhZns8…', txid: '979b923aaf…a4c8ec3ffe', time: '19 Mar. 2026 20:05', status: 'success', source: '20260109034135361185083092' },
  { id: '20260319120511386316580790', symbol: 'USDT', amount: '- 0.5 USDT', chain: 'TRON', fee: '30.288 USDT', to: 'TMhCk9FQs2P7mDGRZ1PhZns8…', txid: 'b946ee5cbc…d5da51f005', time: '19 Mar. 2026 20:05', status: 'success', source: '20260319112811250036702951' },
  { id: '20260318190912385833410287', symbol: 'USDT', amount: '- 0.2 USDT', chain: 'TRON', fee: '28.104 USDT', to: 'TMhCk9FQs2P7mDGRZ1PhZns8…', txid: '5f1c07ab63…9e2d448a10', time: '18 Mar. 2026 19:09', status: 'success', source: '20260318183212122005761331' },
  ...
  { id: '20260318185204385827118463', symbol: 'HBAR', amount: '- 3.5 HBAR', chain: 'Hedera', fee: '0.03042 USDT', to: '0.0.3915672', txid: '', time: '18 Mar. 2026 18:52', status: 'failed', source: '20260318181504755476010902', memo: '010902' },
  ...
  { id: '20260306114310374921065509', symbol: 'USDT', amount: '- 1.5 USDT', chain: 'TRON', fee: '25.641 USDT', to: 'TMhCk9FQs2P7mDGRZ1PhZns8…', txid: 'ab30f6c142…7d1e0c4b95', time: '06 Mar. 2026 11:43', status: 'success', source: '20260306110610810083728455' },
  ...
  { id: '20260201152038427032785429', symbol: 'TRX', amount: '- 0.000001 TRX', chain: 'TRON', fee: '25.641 USDT', to: 'TY8z8xvCRF…m3Xydy2Uof', txid: 'd760b9b96b…2d43ef6f60', time: '01 Feb. 2026 15:20', status: 'success', source: '20260201143938369685607021' },
  ...
  { id: '20251221180543954281156513', symbol: 'HBAR', amount: '- 4.4 HBAR', chain: 'Hedera', fee: '0.00042 USDT', to: '0.0.5561028', txid: '3dfb3316d4…57d06f8262', time: '21 Dec. 2025 18:05', status: 'success', memo: '771205', source: '20251221172443354386610255' },
];
