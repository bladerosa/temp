...
export const PAYMENTS: RiskPayment[] = [
  ...
  { id: '20260319200211386411402277', type: '直接儲值', symbol: 'POL', amount: '+ 4 POL', chain: 'Polygon', from: '0x50e281e7d0…79483c3d31', txid: '0xe95e00773a…6ca9bfaa87', time: '19 Mar. 2026 20:02', reprocess: 'refunded', memo: '', refundId: '20260609075859415970427518' },
  ...
  { id: '20260130102131368895873108', type: '直接儲值', symbol: 'HBAR', amount: '+ 2.5 HBAR', chain: 'Hedera', from: '0.0.5561028', txid: '18e595f612…77a7d8b0fd', time: '30 Jan. 2026 18:21', reprocess: 'refunded', memo: '883921', refundId: '20260319200312386411871079' },
  ...
  { id: '20251228090217356804119730', type: '直接儲值', symbol: 'HBAR', amount: '+ 6 HBAR', chain: 'Hedera', from: '0.0.4728193', txid: '57fb87259d…dd60c6f913', time: '28 Dec. 2025 17:02', reprocess: 'pending', memo: '5501723' },
